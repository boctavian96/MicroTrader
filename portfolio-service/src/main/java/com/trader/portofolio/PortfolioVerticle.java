...
public class PortfolioVerticle extends MicroserviceVerticle {
	...
	public void start() throws Exception {
		...
		publishEventBusService(PortfolioService.PORTFOLIO_SERVICE_NAME, PortfolioService.PORTFOLIO_SERVICE_ADDRESS,
				PortfolioService.class, this::onBusServicePublished);
	}
